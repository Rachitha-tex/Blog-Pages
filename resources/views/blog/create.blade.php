...
@section('content')
 ...
 <form action="/blog" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="title" placeholder="Title...." class="bg-transparent block border-b-2 w-full h-20 text-6xl outline-none">
     <textarea name="description" placeholder="Description..." class="bg-transparent block border-b-2 w-full h-60 text-xl outline-none"></textarea>
     <div class="bg-grey-lighter pt-15">
      <label class="w-44 flex flex-col items-center px-2 py-3 bg-white-rounded-lg shdow-lg tracking-wide uppercase border border-blue cursor-pointer">
