...
@endif
        ...
        @if (Auth::check())
            <div class="pt-15 w-4/5 m-auto">
            <a href="/blog/create" class="bg-blue-500 uppercase bg-transparent text-gray-100 text-xs font-extrabold py-3 px-3 rounded-3xl">Create Post</a>
            </div>
        @endif
        ...
        <div class="sm:grid grid-cols-2 gap-20  w-4/5 mx-auto py-15 border-b border-gray-200">
            <div>
              ...
              <div>
                  ...
                  <p class="text-xl text-gray-700 pt-8 pb-10 leading-8 font-gray">
                {{$post->description}} 
                  </p>
